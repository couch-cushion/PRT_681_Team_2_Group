...
I selected these roles because I want to develop a career in software engineering, with software development as my primary direction and software testing as a complementary career pathway. This research is intended to identify employer expectations and guide my learning, practical work, resume preparation and interview preparation.
...
I searched LinkedIn and SEEK using terms including junior .NET developer, full-stack developer, junior software tester and QA Analyst. I began with Northern Territory opportunities and broadened the search to Australia when suitable junior roles were limited.



I reviewed job titles, responsibilities, required and desirable skills, technologies, qualifications and certifications. I also distinguished between genuinely junior opportunities and experienced positions that could provide longer-term career benchmarks.
...
| Platform / Search                            | Observation                                                                                                       |

| -------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |

| LinkedIn — junior .NET, NT                   | No exact junior .NET position was found in my search. Related and experienced positions appeared.                 |

| SEEK — junior .NET, NT                       | One result was shown: Integration .Net Developer at Centorrino Technologies.                                      |

| SEEK — junior software tester/QA Analyst, NT | Four results were displayed, representing three unique Test Analyst advertisements because MYtech appeared twice. |

| LinkedIn — junior software tester, NT        | Related Test Analyst positions appeared, but they were not established as junior roles.                           |

| SEEK — junior software tester, Australia     | The broader search displayed 72 results, including explicitly junior and entry-level testing opportunities.       |



These figures describe the searches I performed on the research date. They are not a complete count of all available jobs. Search results may contain duplicates, related occupations and positions that do not match the requested experience level.
...
The role involves designing, developing and supporting integrations between systems using C# and .NET. Responsibilities include developing and consuming REST APIs, working with JSON and XML, applying integration patterns, writing maintainable code and unit tests, using Git and CI/CD, collaborating with Business Analysts, and preparing technical documentation.
...
| Category                | Requirements identified                                                   |

| ----------------------- | ------------------------------------------------------------------------- |

| Programming and backend | C#, .NET Framework, modern .NET/.NET Core                                 |

| Integration             | REST APIs, JSON, XML, system-to-system integration                        |

| Software quality        | Clean code, unit testing, troubleshooting                                 |

| Development workflow    | Git, CI/CD, Jira                                                          |

| Design                  | Application architecture, dependency injection, layered architecture      |

| Documentation           | Technical designs, functional specifications, database models             |

| Professional skills     | Requirements understanding, collaboration, communication, problem-solving |
...
Experience with WPF/XAML, web applications or single-page applications is advantageous. Infrastructure knowledge, networking and application security are also beneficial.
...
Because the NT results were mainly experienced positions, I broadened the search to Australia. The following advertisements were identified as relevant entry-level research leads:



| Employer                         | Advertisement                                        | Location  | Observation                                               |

| -------------------------------- | ---------------------------------------------------- | --------- | --------------------------------------------------------- |

| Finity Consulting                | Junior Quality Assurance Engineer                    | Melbourne | Explicitly junior title.                                  |

| Expert360                        | Junior Quality Engineer/Tester (Student Opportunity) | Ballarat  | Explicitly junior/student opportunity.                    |

| Planit Test Management Solutions | Test Analyst – Entry-Level                           | Melbourne | Explicitly entry-level title with a training opportunity. |



The full requirements of these three advertisements have not yet been analysed. They are recorded as evidence that the broader Australian market includes junior/entry-level testing pathways, not as evidence of specific technical requirements.
...
https://au.seek.com/job/94093900

https://au.seek.com/job/94377490
...
The reviewed .NET advertisement emphasises C#/.NET, APIs, integration, unit testing, Git, CI/CD, architecture, documentation and collaboration. These provide a useful direction for my development learning. The advertisement does not establish that a particular frontend framework is required for junior roles.
...
The reviewed Test Analyst advertisements repeatedly emphasise:



| Skill area                                          | Why employers need it                                             |

| --------------------------------------------------- | ----------------------------------------------------------------- |

| Requirements analysis                               | To understand what the system must do and identify test coverage. |

| Test plans, cases and scripts                       | To make testing systematic, repeatable and documented.            |

| Functional, integration, regression and UAT testing | To check different aspects of system quality.                     |

| Defect management                                   | To record, investigate, track and retest problems.                |

| Jira / Azure DevOps                                 | To manage testing work and defects.                               |

| SQL and test-data validation                        | To check stored data and verify expected results.                 |

| Documentation and traceability                      | To show what was tested and connect tests to requirements.        |

| Communication and collaboration                     | To work effectively with developers, analysts and stakeholders.   |



Automation, non-functional testing, Agile/DevOps and complex integration experience are useful additional learning areas.
...
The .NET advertisement requests a relevant qualification or equivalent professional experience but does not specify a named technical certification.
...
Some searches returned occupations outside my two target roles, including Service Improvement Analyst, UX Business Analyst and industrial QA/QC Coordinator. These roles involve different responsibilities and should not be used to define software developer or software tester requirements.
...
Based on the advertisements, my career preparation should focus on:
...
The professor’s specific learning links will be used where provided. Where no specific link is supplied, the topic will be taught and practised as part of the assignment learning process.
